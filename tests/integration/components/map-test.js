...
module("Integration | Component | map", function (hooks) {
  ...
  test("the default alt attribute can be overriden", async (assert) => {
    await render(hbs`<Map
    @lat="37.7797"
    @lng="-122.4184"
    @zoom="10"
  ...
  test("the src, width and height attributes cannot be overriden", async (assert) => {
    await render(hbs`<Map
    @lat="37.7797"
    @lng="-122.4184"
    @zoom="10"
